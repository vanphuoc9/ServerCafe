				...
				<div class="row">
					<div class="col-lg-12">
						<div class="page-header">
							...
							<button class="btn btn-primary btn-them" data-toggle="modal" data-target="#myModalThem">Thêm loại sản phẩm</button>
					...
					<div class="col-lg-12">
						<table class="table table-striped table-bordered table-hover" id="myTable">
						  <thead>
						   ...
						   <tbody>
						   	@foreach($loaisanpham as $lm)
						      <tr class="odd gradeX" align="center">
						        <td>{{$lm->TENLOAI}}</td>
                                <td><img src="{{$lm->HINH}}" width="100px" height="100px"></td>
                         		<td class="center"><i class="glyphicon glyphicon-remove"></i><a href="" data-id="{{$lm->MALOAISP}}" id="btnXoa">Xóa</a></td>
                                <td class="center"><i class="glyphicon glyphicon-pencil"></i> <a href="" data-id="{{$lm->MALOAISP}}" id="btnSua">Sửa</a></td>
	                  ...
	                  <div class="modal-dialog">
	                     ...
	                     <div class="modal-content">
	                        ...
	                        <div class="modal-body">
	                           <form class="ValidatorFrom" action="admin/loaisanpham/them" role="form" data-toggle="validator" method="POST" >
	                              <div class="form-group">
	                                 <label for="Ten"><span class="glyphicon glyphicon-user"></span> Tên loại sản phẩm</label>
...
@section('script')
	  ...
	  $(document).on('click', '#btnXoa', function (e) {
			...
			Swal({
			  ...
			  cancelButtonText: 'Không, giữ lại'
				  ...
				  if (result.value) {		
					window.location.href = "admin/loaisanpham/xoa/" + id;            		
	...
	<script>
	  $(document).on('click', '#btnSua', function (e) {
		    ...
		    var id = $(this).data('id');
		   /*      alert(id); */
		    $.get("admin/loaisanpham/sua/"+id,function(data){
		    	 /*    alert(id);*/
		    	/*     console.log(data);  */
					
					$('#updateFrom').attr("action","admin/loaisanpham/sua/"+id);
